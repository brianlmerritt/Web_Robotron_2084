...
class Player extends Actor {
    constructor(game) {
        super(game, 14, 24);
        this.screenX = game.ui.canvas.width / 2 - this.width / 2;
        this.screenY = game.ui.canvas.height / 2 - this.height / 2;
    ...
    centerOnCanvas(canvas) {
        this.screenX = canvas.width / 2 - this.width / 2;
        this.screenY = canvas.height / 2 - this.height / 2;
    }
